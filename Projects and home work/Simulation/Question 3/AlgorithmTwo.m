...
v = W1+W2+W3;
OPTION = sdpsettings('solver','lmilab','verbose',0);
res = optimize(F,[],OPTION)
check(F)
...
delta2=mu2-mu20;
delta3=mu3-mu30;
W1new=W1-2*(1/mu10)*Z10'*Z1+(1/mu10)*Z10'*Z10;
W2new=W2-2*(1/mu20)*Z20'*Z2+(1/mu20)*Z20'*Z20;
W3new=W3-2*(1/mu30)*Z30'*Z3+(1/mu30)*Z30'*Z30;
